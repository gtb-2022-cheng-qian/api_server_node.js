...
router.post('/register', expressJoi(reg_login_schema), routeHandler(userController.register))
// 登录
// 1.检测表单数据是否合法
router.post('/login', expressJoi(reg_login_schema), routeHandler(userController.login))
